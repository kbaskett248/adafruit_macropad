...
def normalize_colors():
    ...
    This function allows defining colors in the scheme in terms of the names
    of other colors in the scheme. Note that this method is not recursive,
    so if you have multiple levels of indirection, you will need to call this
    functions multiple times.
    """
    for name, color in color_scheme.items():
        if isinstance(color, str):
            color_scheme[name] = color_scheme[color]
